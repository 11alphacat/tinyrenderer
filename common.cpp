/*
    common used math and graphic function definitions;
*/
#include "common.h"
...
void line(vec2 from, vec2 to, TGAImage &framebuffer, const TGAColor& color) {
    int ax { static_cast<int>(from[0]) }, ay { static_cast<int>(from[1]) };
    int bx { static_cast<int>(to[0]) }, by { static_cast<int>(to[1]) };
    bool steep { false };  
